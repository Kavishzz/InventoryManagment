...
const DashboardPage = () => {
    ...
    //variable to store and set transaction data formatted for chart display
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                showMessage(
                    error.response?.data?.message || "Error in getting transactions: " + error
                );
            }
        }
        fetchData();
    ...
    const transformTransactionData = (transactions, month, year) => {
        ...
        //process each transactons to accumulate daily counts, quantity and amount
        transactions.forEach(transaction => {
            const transactionDate = new Date(transaction.createdAt);
            const transactionMonth = transactionDate.getMonth() + 1;
            const transactionYear = transactionDate.getFullYear();

            //If transaction falls within selected month and year, accumulate data for day
        ...
        //return dailyData object for chart compatibility
