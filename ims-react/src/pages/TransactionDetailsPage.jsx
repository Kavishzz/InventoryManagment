...
const TransactionDetailsPage = () => {
    ...
    useEffect(() => {
        const getTransaction = async () => {
            ...
            try {
                ...
                showMessage(
                    error.response?.data?.message || "Error in getting transaction: " + error
                );
            }
        };
        getTransaction();
    ...
    const handleUpdateStatus = async () => {
        try {
            const data = ApiService.updateTransactionStatus(transactionId, status);
            navigate("/transaction")
        } catch (error) {
            showMessage(
                error.response?.data?.message || "Error in updating transaction status: " + error
            );
        }
    };
            ...
            <div className="transaction-details-page">
                {transaction && (
                    <>
                        ...
                        {/*User information who made transaction*/}
                        <div className="section-card">
                        ...
                        {/*Supplier information who made transaction*/}
